  ...
  return (
    ...
    >
      ...
      <div className="w-full flex flex-wrap  ">
        ...
        <motion.div
          variants={itemVariants}
          className="flex  justify-center sm:justify-start items-center w-full mt-3 md:mt-2 lg:mt-3  "
        >
          <p className="text-[#1e1e1e] md:text-[10px] lg:text-[11px] xl:text-[14px] 2xl:text-[16px] dark:text-[#848484] ">
