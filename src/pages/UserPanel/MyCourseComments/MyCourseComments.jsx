...
const MyCourseComments = () => {
  ...
  return (
    <div className="flex flex-col gap-10 lg:gap-5 2xl:gap-0  h-[84%] w-full mt-4 p-8 bg-[#F3F4F6] rounded-4xl dark:bg-[#333333]">
      ...
      <div className="flex  flex-col justify-between md:overflow-y-auto lg:overflow-y-hidden rounded-2xl bg-[#f3f4f6] p-3 dark:bg-[#333] sm:p-4 md:p-5 lg:p-6">
            ...
            <div className="overflow-hidden rounded-2xl border border-[#EAEAEA] dark:border-[#5a5a5a]">
              <table className="w-full table-fixed border-collapse">
                <thead className="bg-[#FAFAFA] dark:bg-[#4B4B4B]">
                  <tr>
                    <th className="w-[24%] border-b border-[#EAEAEA] px-4 py-4 text-right text-[13px] font-bold text-[#1E1E1E] dark:border-[#5a5a5a] dark:text-[#DDDDDD] xl:px-5 xl:text-[14px] 2xl:text-[15px]">
                      {t("myCourseComments.title1")}
                    </th>

                    <th className="w-[17%] border-b border-[#EAEAEA] px-3 py-4 text-center text-[13px] font-bold text-[#1E1E1E] dark:border-[#5a5a5a] dark:text-[#DDDDDD] xl:px-4 xl:text-[14px] 2xl:text-[15px]">
                      {t("myCourseComments.title2")}
                    </th>

                    <th className="w-[24%] border-b border-[#EAEAEA] px-3 py-4 text-center text-[13px] font-bold text-[#1E1E1E] dark:border-[#5a5a5a] dark:text-[#DDDDDD] xl:px-4 xl:text-[14px] 2xl:text-[15px]">
                    ...
                    <th className="w-[13%] border-b border-[#EAEAEA] px-3 py-4 text-center text-[13px] font-bold text-[#1E1E1E] dark:border-[#5a5a5a] dark:text-[#DDDDDD] xl:px-4 xl:text-[14px] 2xl:text-[15px]">
                  ...
                  {isPending ? (
                    [...Array(commentsPerPage)].map((_, index) => (
                      <tr key={index} className="bg-white dark:bg-[#454545]">
                        ...
                        >
                          <div className="grid grid-cols-[1.3fr_1.1fr_1.4fr_0.8fr_1fr_0.6fr] items-center gap-3">
        ...
        <div className="mt-5 flex flex-col gap-3 lg:mt-7 xl:mt-5 lg:flex-row lg:items-center lg:justify-start">
          <ReactPaginate
            breakLabel="..."
            nextLabel="›"
            previousLabel="‹"
