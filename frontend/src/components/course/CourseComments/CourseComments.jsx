...
const CourseComments = ({ course }) => {
  ...
  const courseCommentsDataa = [
    {
      id: 1,
      commentUserName: "ادوارد جانسون",
      commentDate: "9 خرداد 1404",
      commentTitle: "عنوان کامنت",
      commentDescribe: "متن کامنت",
      commentLikeCount: 200,
      commentDisLikeCount: 200,
    },
    {
      id: 2,
      commentUserName: "ادوارد جانسون",
  ...
  const { data: courseCommentsData, isLoading } = useQuery({
    queryKey: ["GETCOURSECOMMENTS"],
    queryFn: () => getCourseComments(course.courseId),
  });
